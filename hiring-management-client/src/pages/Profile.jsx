              ...
              <Form className="w-full space-y-6">
                ...
                <div>
                  <Field
                    type="text"
                    name="experience"
                    placeholder="Experience in year Ex:- 2.6"
                    className="w-full p-4 border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <ErrorMessage
                    name="experience"
                ...
                <div>
                  <Field
                    type="text"
                    name="education"
                    placeholder="Highest Education Ex:- Master Of Compter Application"
                    className="w-full p-4 border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <ErrorMessage
                    name="education"
                ...
                <div>
                  <Field
                    type="text"
                    name="designation"
                    placeholder="Current Designation Ex:- Software Developer"
                    className="w-full p-4 border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <ErrorMessage
                    name="designation"
